                    ...
                    <div class="col-lg-9">
                        <div class="single-page pt-50 pr-30">
                            <div class="single-header style-2">
                                <div class="row">
                                    <div class="col-xl-10 col-lg-12 m-auto">
                                        ...
                                        <h2 class="mb-10">{{ $blogdetails->title }}</h2>
                            ...
                            <figure class="single-thumbnail">
                                <img src="{{ asset($blogdetails->image) }}" alt="" style="width: 500px; height: 400px;" />
                            </figure>
                            <div class="single-content">
                                <div class="row">
                                    <div class="col-xl-10 col-lg-12 m-auto">
                                        <p class="single-excerpt"> {!! $blogdetails->long_description !!} </p>
                                        <!--Entry bottom-->
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget-category-2 mb-50">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop-grid-right.html"> <img src="{{ asset('frontend/assets/imgs/theme/icons/category-1.svg') }}" alt="" />{{ $category->
                                            name }}</a><span class="count">{{ count($posts) }}</span>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
