...
@section('main')
    ...
    <div class="container mb-30">
        <div class="row flex-row-reverse">
            ...
            <form method="post" action="{{route('shop.filter')}}" class="col-lg-1-5 primary-sidebar sticky-sidebar">
                    @csrf
                <!-- Fillter By Price -->
                <div class="sidebar-widget price_range range mb-30">
                    ...
                    <a type="submit" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Fillter</a>
                </div>
            </form>
