...
case 'pending':
$status = 'Confirm';
$link = 'admin.order.confirm';
$id="confirmed";
break;
case 'confirmed':
$status = 'Processing';
$link = 'admin.order.processed';
$id="processing";
break;
case 'processing':
$status = 'delivered';
$link = 'admin.order.delivered';
$id="delivered";
break;
default:
$status = '';
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table" style="background:#F4F6FA;font-weight: 600;">
                        ...
                        <tr>
                            <th> </th>
                            <th><a id={{$id}} href="{{route($link,$order)}}" class="btn btn-block btn-success">{{$status}}</a> </th>
                        </tr>
                        @endif
                    </table>
