                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('admin.blog.post.update') }}" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea name="post_short_description" class="form-control" id="inputProductDescription" rows="3">{{$post->short_description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea id="mytextarea" name="post_long_description"> {{$post->long_description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{($post->image) ? asset($post->image) : asset('upload/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                                        </div>
                                    </div>
